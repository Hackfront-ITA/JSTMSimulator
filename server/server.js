...
var finalHTML = [
	...
	'  <title>Turing Machine Competition</title>',
	htmlheadHtml,
	'  <style>',
	...
	iecsshacksHtml,
	'</head>',
	'<body class="loadmode savemode">',
	turingMachineHtml,
	'  <script>',
	uglifyjs.minify('(function(){' + turingMachineJS + i18nJS + json3JS + 'var handleConnection = function(username, contestProblems){' + handleHTMLPageJS + handleContestProblemsJS + '};' + xmlhttpfuncJS + xmlhttpContestJS + '})();', {fromString: true}).code,
	'  </script>',
	'</body>',
	'</html>'
